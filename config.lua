...
-- Raw GitHub (bytes do .otbm). Gravado como world/{mapName}.otbm; fork rodviana/canary branch rodrigo.
toggleDownloadMap = true
mapDownloadUrl = "https://raw.githubusercontent.com/rodviana/canary/rodrigo/data-otservbr-global/world/custom/otservbr-custom.otbm"
mapName = "otservbr"
mapAuthor = "rodviana"
