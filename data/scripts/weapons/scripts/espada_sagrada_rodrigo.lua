...
local sacredSword = Weapon(WEAPON_SWORD)

function sacredSword.onUseWeapon(player, variant)
	return combat:execute(player, variant)
end

sacredSword:id(51309)
sacredSword:attack(42)
sacredSword:defense(35)
sacredSword:register()
